...
mod tests {
    ...
    // Stateful negative-path coverage for AuthService: real challenge
    // lifecycle (unknown/expired nonce, wrong game, sig mismatch, valid
    // round-trip) using a real ECDSA wallet.
