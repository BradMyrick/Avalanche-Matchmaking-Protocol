...
namespace CapnpGen
{
    [System.CodeDom.Compiler.GeneratedCode("capnpc-csharp", "1.3.0.0"), TypeId(0xbd0584aee30eb59fUL)]
    public class MatchConfig : ICapnpSerializable
    {
        public const UInt64 typeId = 0xbd0584aee30eb59fUL;
    ...
    [System.CodeDom.Compiler.GeneratedCode("capnpc-csharp", "1.3.0.0"), TypeId(0x82dcfa892cbade38UL)]
    public class InputFrame : ICapnpSerializable
    {
        public const UInt64 typeId = 0x82dcfa892cbade38UL;
        void ICapnpSerializable.Deserialize(DeserializerState arg_)
        {
            var reader = READER.create(arg_);
    ...
    [System.CodeDom.Compiler.GeneratedCode("capnpc-csharp", "1.3.0.0"), TypeId(0xbeca4c67b1c0ad05UL)]
    public class GameEvent : ICapnpSerializable
    {
        public const UInt64 typeId = 0xbeca4c67b1c0ad05UL;
        void ICapnpSerializable.Deserialize(DeserializerState arg_)
        {
            var reader = READER.create(arg_);
