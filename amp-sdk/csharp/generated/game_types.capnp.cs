...
namespace CapnpGen
{
    [System.CodeDom.Compiler.GeneratedCode("capnpc-csharp", "1.3.0.0"), TypeId(0xc112e9e4e9063aa7UL)]
    public class TurnBasedReplay : ICapnpSerializable
    {
        public const UInt64 typeId = 0xc112e9e4e9063aa7UL;
    ...
    [System.CodeDom.Compiler.GeneratedCode("capnpc-csharp", "1.3.0.0"), TypeId(0x8c1009f863514607UL)]
    public class SignedMove : ICapnpSerializable
    {
        public const UInt64 typeId = 0x8c1009f863514607UL;
        void ICapnpSerializable.Deserialize(DeserializerState arg_)
        {
            var reader = READER.create(arg_);
    ...
    [System.CodeDom.Compiler.GeneratedCode("capnpc-csharp", "1.3.0.0"), TypeId(0xecb22473c992d36eUL)]
    public class RealtimeTranscript : ICapnpSerializable
    {
        public const UInt64 typeId = 0xecb22473c992d36eUL;
        void ICapnpSerializable.Deserialize(DeserializerState arg_)
        {
            var reader = READER.create(arg_);
    ...
    [System.CodeDom.Compiler.GeneratedCode("capnpc-csharp", "1.3.0.0"), TypeId(0x928b3870870d29bfUL)]
    public class StateSnapshot : ICapnpSerializable
    {
        public const UInt64 typeId = 0x928b3870870d29bfUL;
        void ICapnpSerializable.Deserialize(DeserializerState arg_)
        {
            var reader = READER.create(arg_);
    ...
    [System.CodeDom.Compiler.GeneratedCode("capnpc-csharp", "1.3.0.0"), TypeId(0xb775b35e74a8319bUL)]
    public class OracleResult : ICapnpSerializable
    {
        public const UInt64 typeId = 0xb775b35e74a8319bUL;
        void ICapnpSerializable.Deserialize(DeserializerState arg_)
        {
            var reader = READER.create(arg_);
