...
namespace CapnpGen
{
    [System.CodeDom.Compiler.GeneratedCode("capnpc-csharp", "1.3.0.0"), TypeId(0xb761081927106316UL)]
    ...
    [System.CodeDom.Compiler.GeneratedCode("capnpc-csharp", "1.3.0.0"), TypeId(0xb15cded8c5c4e708UL)]
    public class AmpTelemetryEvent : ICapnpSerializable
    {
        public const UInt64 typeId = 0xb15cded8c5c4e708UL;
    ...
    [System.CodeDom.Compiler.GeneratedCode("capnpc-csharp", "1.3.0.0"), TypeId(0x8f68c7911ee24a3cUL), Proxy(typeof(TelemetryReceiver_Proxy)), Skeleton(typeof(TelemetryReceiver_Skeleton))]
    ...
    [System.CodeDom.Compiler.GeneratedCode("capnpc-csharp", "1.3.0.0"), TypeId(0x8f68c7911ee24a3cUL)]
    public class TelemetryReceiver_Proxy : Proxy, ITelemetryReceiver
    {
        public async Task LogEvent(CapnpGen.AmpTelemetryEvent @event, CancellationToken cancellationToken_ = default)
        {
            ...
            {Event = @event};
            arg_?.serialize(in_);
            using (var d_ = await Call(10333728771103935036UL, 0, in_.Rewrap<DynamicSerializerState>(), false, cancellationToken_).WhenReturned)
            {
    ...
    public class TelemetryReceiver_Skeleton : Skeleton<ITelemetryReceiver>
    {
        ...
        public override ulong InterfaceId => 10333728771103935036UL;
    ...
    {
        [System.CodeDom.Compiler.GeneratedCode("capnpc-csharp", "1.3.0.0"), TypeId(0xec59ec30cb262183UL)]
        public class Params_LogEvent : ICapnpSerializable
        {
            public const UInt64 typeId = 0xec59ec30cb262183UL;
            void ICapnpSerializable.Deserialize(DeserializerState arg_)
            {
                var reader = READER.create(arg_);
        ...
        [System.CodeDom.Compiler.GeneratedCode("capnpc-csharp", "1.3.0.0"), TypeId(0xaa1ef40f61880eb3UL)]
        public class Result_LogEvent : ICapnpSerializable
        {
            public const UInt64 typeId = 0xaa1ef40f61880eb3UL;
            void ICapnpSerializable.Deserialize(DeserializerState arg_)
            {
                var reader = READER.create(arg_);
                applyDefaults();
