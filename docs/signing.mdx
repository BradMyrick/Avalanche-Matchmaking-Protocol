...
protocol. All SDKs MUST produce byte-identical signatures for cross-language
interop. See `SECURITY_REVIEW.md` for the threat model and remediation status.
...
- `SECURITY_REVIEW.md` — threat model and remediation status
