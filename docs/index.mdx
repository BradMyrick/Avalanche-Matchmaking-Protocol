...
5. Runs the **Multi-Language SDK Proofs** (simulated players using C++, C#, and Go).
6. Validates the transcript, generates the verifier attestation, and settles the match on-chain.
...
- **Integration & SDK**: End-to-end guides for integrating AMP into your game using our **Native C++, C#, Go, and Python SDKs**.
