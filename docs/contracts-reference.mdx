...
The AMP protocol is powered by two primary smart contracts on the Avalanche Fuji Testnet. Both contracts use OpenZeppelin v5.6.1, pragma `^0.8.33`, and implement `Ownable2Step`, `Pausable`, and `ERC2771Context` (meta-transactions).
...
- `ERC2771Context`: Supports meta-transactions via a trusted forwarder.
...
Run the 31 tests (17 Registry + 14 Settlement):
